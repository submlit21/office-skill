...
class PptxHandler:
    ...
    def add_slide(self, layout: str = "Title and Content", index: Optional[int] = None) -> Dict[str, Any]:
        """
        ...
        if index is not None:
            kwargs["index"] = index
        return self.cli.impress("add-slide", **kwargs)
    ...
    def remove_slide(self, index: int) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.impress("remove-slide", index=index)
    ...
    def set_content(self, slide_index: int, title: Optional[str] = None,
        ...
        Returns:
            Command result
        """
        kwargs = {"slide": slide_index}
        if title is not None:
            kwargs["title"] = title
        if content is not None:
            kwargs["content"] = content
        return self.cli.impress("set-content", **kwargs)
    ...
    def set_layout(self, slide_index: int, layout: str) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.impress("set-layout", slide=slide_index, layout=layout)
    ...
    def add_element(self, slide_index: int, element_type: str, **kwargs) -> Dict[str, Any]:
        ...
        all_kwargs = {"slide": slide_index, "type": element_type}
        all_kwargs.update(kwargs)
        return self.cli.impress("add-element", **all_kwargs)
    ...
    def modify_element(self, slide_index: int, element_index: int, **kwargs) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        all_kwargs = {"slide": slide_index, "element": element_index}
        all_kwargs.update(kwargs)
        return self.cli.impress("modify-element", **all_kwargs)
    ...
    def set_speaker_notes(self, slide_index: int, notes: str) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.impress("set-speaker-notes", slide=slide_index, notes=notes)
    ...
    def get_speaker_notes(self, slide_index: int) -> Dict[str, Any]:
        ...
        Returns:
            Speaker notes text
        """
        return self.cli.impress("get-speaker-notes", slide=slide_index)
    ...
    def export(self, output_path: str, format: str = "pdf") -> Dict[str, Any]:
        ...
        return self.cli.export("render",
                              input=str(self.presentation_path),
                              output=output_path,
                              preset=format)
