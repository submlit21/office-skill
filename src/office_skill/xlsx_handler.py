...
class XlsxHandler:
    ...
    def get_cell(self, sheet: str, cell_ref: str) -> Dict[str, Any]:
        ...
        """
        return self.cli.calc("get-cell", sheet=sheet, cell=cell_ref)

    def set_cell(self, sheet: str, cell_ref: str, value: str, formula: bool = False) -> Dict[str, Any]:
        """
        Set a cell value.
        ...
        if formula and not value.startswith("="):
            value = f"={value}"
        return self.cli.calc("set-cell", sheet=sheet, cell=cell_ref, value=value)
    ...
    def set_cell_format(self, sheet: str, cell_ref: str, format_spec: str) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.calc("set-cell-format", sheet=sheet, cell=cell_ref, format=format_spec)
    ...
    def add_sheet(self, name: str, index: Optional[int] = None) -> Dict[str, Any]:
        ...
        if index is not None:
            kwargs["index"] = index
        return self.cli.calc("add-sheet", **kwargs)
    ...
    def remove_sheet(self, sheet: str) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.calc("remove-sheet", sheet=sheet)
    ...
    def rename_sheet(self, old_name: str, new_name: str) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.calc("rename-sheet", sheet=old_name, name=new_name)
    ...
    def merge_cells(self, sheet: str, range_ref: str) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.calc("merge", sheet=sheet, range=range_ref)
    ...
    def unmerge_cells(self, sheet: str, cell_ref: str) -> Dict[str, Any]:
        ...
        Returns:
            Command result
        """
        return self.cli.calc("unmerge", sheet=sheet, ref=cell_ref)
    ...
    def export(self, output_path: str, format: str = "pdf") -> Dict[str, Any]:
        ...
        return self.cli.export("render",
                              input=str(self.spreadsheet_path),
                              output=output_path,
                              preset=format)
    ...
    def apply_financial_formatting(self, sheet: str,
                                   currency_cells: List[str] = None,
                                   percent_cells: List[str] = None) -> Dict[str, Any]:
        """
